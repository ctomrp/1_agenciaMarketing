...
export default function PositionList() {
    return(
        <div className="max-w-full mx-auto lg:mx-12 bg-white">
            ...
            <p className="text-2xl font-regular max-w-5xl leading-10 text-gray-900 pb-8">Let's write some beautiful code and make smart designs. This is what we're crazy about, and we're looking for the ones who feel the same.</p>
