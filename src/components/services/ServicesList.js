...
export default function ServicesList({section_title, posts}){
    return(
        ...
        <div className="relative mx-auto lg:mx-12 max-w-full">
          ...
          <div className="mx-auto lg:mx-12 mt-14 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
            {posts.map((post, index) => (
                <ServiceCard post={post} index={index}/>
            ))}
          </div>
        </div>
      </div>
